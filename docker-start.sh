...
if [ ! -f config.yaml ]; then
    ...
    if [ -f config.example.yaml ]; then
        ...
        echo ""
        echo "You can also configure these settings in the React console after starting."
        echo ""
    else
...
echo ""
echo "Services:"
echo "  🌐 Console: http://localhost:8000/#/board"
echo "  🔌 API:     http://localhost:8000/api/info"
