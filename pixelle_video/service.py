...
class PixelleVideoCore:
    ...
    def _get_comfykit_config(self) -> dict:
        ...
        if comfyui_config.get("runninghub_url"):
            kit_config["runninghub_url"] = comfyui_config["runninghub_url"]
    ...
    async def initialize(self):
        ...
        standard_pipeline = StandardPipeline(self)
        self.pipelines = {
            ...
            "topic_to_long_form": LongFormPipeline(self),
